...
#define BM 128  // block tile: rows of C this block owns (bigger vs baseline)
#define BN 128  // block tile: cols of C this block owns (bigger vs baseline)
#define BK 8    // K-dimension chunk size
